...
//      }
  ...
  private function getElementsByTags() {
    ...
    $textTags = $this->xpath->query('/html/body//text()');
    ...
    //author
    $article_author = '';
    $author = $this->xpath->query('//*[@rel="author"][1]')->item(0);
    if ($author) {
      $article_author = $author->nodeValue;
    }
    //date
    $article_date = '';
    $date = $this->xpath->query('//*[@datetime][1]')->item(0);
    if ($date) {
