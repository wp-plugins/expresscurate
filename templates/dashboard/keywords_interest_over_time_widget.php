  ...
  <div>
      <?php if (sizeof($keywordsArray) != 0) {?>
          <div class="expresscurate_background_wrap ">
              <script type="text/javascript" src="//www.google.com/trends/embed.js?hl=en-US&q=<?php echo $query; ?>&cmpt=q&tz&tz&content=1&cid=TIMESERIES_GRAPH_0&export=5&w=350&h=300"></script>
          </div>
      <?php } else { ?>
