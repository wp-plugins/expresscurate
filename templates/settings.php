...
<ul>
<li>
    <div class="title">Image Placement<div class="description">
            ...
            <ol>
                <li>Featured. The image will be placed above the title, at the very top of your post. This will give
                    your image a more prominent look.</li>
                <li>Standard. The image will be placed below the title and category. This option will focus your
                    viewer's attention more on the title and less on the image.</li>
            </ol>
          </div></div>
    ...
    ?> />
    <label class="controls expresscurate_radioLabel " for="expresscurate_featured"> Featured </label>
    <input class="controls expresscurate_featured" type="radio" id="expresscurate_featured_no" value="0"
           name="expresscurate_featured" <?php
    if (get_option('expresscurate_featured', '') == "0") {
        echo 'checked="checked"';
    }
    ?> />
    <label class="controls expresscurate_radioLabel" for="expresscurate_featured_no"> Standard </label>
</li>
<li>
    <label for="expresscurate_curated_text" class="title">Attribution Text For Original Article Link<span class="description">Type in the prefix text for attributing the original article link.
...
<li>
    <label for="expresscurate_max_tags" class="title">Max Number of Auto-suggested Tags<span class="description">&nbsp;&nbsp; The recommended value is 3.<br/>
...
<li>
    <label for="expresscurate_autosummary" class="title">Number of Curated Paragraphs<span class="description  ">Pick the number of paragraphs to be inserted from the original article into your post.</span>
            ...
            <ul>
                <li>
                    ...
                    <div id="smartPublishingWrap" class="<?php echo $show_interval; ?>">
                        ...
                        <select class="controls" id="expresscurate_hours_interval" name="expresscurate_hours_interval">
                            <?php
                            for ($i = 1; $i < 14; $i++) {
                                ?>
                                <?php if ($i == 1) { ?>
...
<div id="tab-4" class="tab-content">
    ...
    <li>
        <p class="title">Publishing Directly from ExpressCurate Chrome Extension<span class="description  ">This setting gives you an option to save your curated post as a draft or publish it when you click on the "Curate" button on ExpressCurate Chrome extension.</span>
        </p>
        <div class="extLabelWrapper">
            ...
            ?> />
            <label class="controls expresscurate_radioLabel" for="expresscurate_post_published"> Published </label>
            ...
            ?> />
            <label class="controls expresscurate_radioLabel" for="expresscurate_post_draft"> Draft </label>
        </div>
        </li>
    </ul>
        <div class="centerSave">
            ...
            <ul>
                <li>
                    <div class="title">
                        ...
                        <div class="description">
                            Would you like to receive email alerts when keyword matches are found in your <a href="#">Content Feed</a>?
                        </div>
                    </div>
                ...
                <li class="emailAlertSlider <?php if (get_option('expresscurate_enable_content_alert') != 'on') echo 'expresscurate_displayNone'; ?>">
                    <div class="title">
                        ...
                        <div class="description">
                            How frequently should ExpressCurate send content Alert Email (from RSS feeds, Alerts, etc)
                        </div>
                    </div>
                    <select class="controls" id="expresscurate_content_alert_frequency" name="expresscurate_content_alert_frequency">
                        <?php
                        for ($i = 1; $i < 14; $i++) {
                            ?>
                            <?php if ($i == 1) { ?>
                ...
                <li>
                    <div class="title">
                        ...
                        <div class="description">
                            How frequently should ExpressCurate pull content (from RSS feeds, Alerts, etc) into your <a href="#">Content Feed</a>?
                        </div>
                    </div>
                    <select class="controls" id="expresscurate_pull_hours_interval" name="expresscurate_pull_hours_interval">
                        <?php
                        for ($i = 1; $i < 14; $i++) {
                            ?>
                            <?php if ($i == 1) { ?>
