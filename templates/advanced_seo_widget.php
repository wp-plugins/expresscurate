...
<div class="container expresscurate_Styles expresscurate_advancedSEO_widget">
    ...
    <ul class="tabs">
        ...
        <li class="tab-link expresscurate_preventTextSelection red <?php if (get_option('expresscurate_sitemap_update_permission') == 'error') echo 'disabled'; ?>"
            data-tab="tab-2">Sitemap
        </li>
        <li class="tab-link expresscurate_preventTextSelection blue" data-tab="tab-3">Social</li>
        <li class="tab-link postAnalysisLink expresscurate_preventTextSelection yellow" data-tab="tab-4">Post Analysis
        </li>
    </ul>
    ...
    <div id="tab-1" class="tab-content current">
        ...
        <div id="expresscurate_advancedSEO_widget">
            <div id="expresscurate_ClonePostWrap" class="<?php if(!$postCopy) {echo 'expresscurate_displayNone';} ?>">
                <div class="info">
                    <label for="expresscurate_advanced_seo_post_copy" class="label">Content cloned</label>
                </div>
                <div class="value">
            ...
            <div class="info">
                <label for="expresscurate_advanced_seo_canonical_url" class="label">Canonical URL</label>
            </div>
            <div class="value">
